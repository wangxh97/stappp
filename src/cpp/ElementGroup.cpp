...
void CElementGroup::CalculateMemberSize()
{
 	switch (ElementType_)
    {
        ...
        case ElementTypes::Bar:
            ...
            break;
		case ElementTypes::C3D20R:
			ElementSize_ = sizeof(CC3D20R);
			MaterialSize_ = sizeof(C3D20RMaterial);
			break;
        default:
...
void CElementGroup::AllocateMaterials(std::size_t size)
{
    switch(ElementType_)
    {
        case ElementTypes::Bar:
            ...
            break;
		case ElementTypes::C3D20R:
			MaterialList_ = new C3D20RMaterial[size];
			break;
        default:
